...
4. **📂 Target Work Area (Sandbox):** Drag and drop an empty GameObject (Folder) from your Hierarchy here. GEP will exclusively sync objects within this folder, preventing your other scene objects from being accidentally modified.
